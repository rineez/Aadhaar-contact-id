...
public class PersistentCookieStore implements CookieStore {
    private static final String LOG_TAG = "com.livares.aadhaar.net.http.PersistentCookieStore";
    private static final String COOKIE_PREFS = "com.livares.aadhaar.CookiePrefsFile";
